...
M.generateContainerTexture = function() 
    ...
    canvas:renderTo(function() 
        ...
        love.graphics.draw(texture, quads[343], 16, 0)
        love.graphics.draw(texture, quads[346], 32, 0)

        love.graphics.draw(texture, quads[344], 0, 16)
        love.graphics.draw(texture, quads[349], 32, 16)

        love.graphics.draw(texture, quads[347], 0, 32)
        love.graphics.draw(texture, quads[348], 16, 32)
        love.graphics.draw(texture, quads[351], 32, 32)
...
M.generatePanelTexture = function(w, h)
    ...
    canvas:renderTo(function()
        ...
        for x = 16, w - 24, 8 do
            ...
            love.graphics.draw(texture, quads[338], x, h - 16)
        end

        -- middle
        for y = 16, h - 24, 8 do
            love.graphics.draw(texture, quads[334], 0, y)
            love.graphics.draw(texture, quads[339], w - 16, y)
        end
